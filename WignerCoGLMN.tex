...
\prod_{k\in I'} \left(\bar{\beta}_r - \bar{\alpha}_k - (-1)^{(k)}\right) 
}
{
(\bar{\beta}_r-\bar{\alpha}_u + 1)
\prod_{k\in \tilde{I'},k\neq r} \left(\bar{\beta}_r - \bar{\beta}_k \right)
\prod_{k\in I',k\neq u} \left(\bar{\alpha}_u - \bar{\alpha}_k - (-1)^{(k)}\right)
}
\right]^{1/2}
...
\frac{
(-1)^{|I|}
\prod_{k\in I} \left(\beta_r - \alpha_k - (-1)^{(k)}\right)
\prod_{k\in\tilde{I},k \neq r} \left(\beta_k - \alpha_u \right)
}
{
({\beta}_r-{\alpha}_u + 1)
\prod_{k\in \tilde{I},k\neq r} \left(\beta_r - \beta_k \right)
\prod_{k\in I,k\neq u} \left(\alpha_u - \alpha_k - (-1)^{(k)}\right)
} 
\right]^{1/2}
...
\begin{align*}
{\bar{\alpha}}_i &= i - 1 -\Lambda_i  , &1\leq i\leq m-1, \\
{\bar{\alpha}}_\mu &= \Lambda_\mu + m + 1 - \mu  ,  &1\leq \mu \leq n , \\ 
{\alpha}_i &= \Lambda_i + m - n - i  , &1\leq i\leq m-1, \\
{\alpha}_\mu &= \mu - \Lambda_\mu -n, &1\leq \mu \leq n , \\
\bar{\beta}_i  &= i - 1 -{\tilde{\Lambda}}_i , &1\leq i\leq m, \\
\bar{\beta}_\mu &= {\tilde{\Lambda}}_\mu + m + 1 - \mu,  &1\leq \mu \leq n + 1, \\
\beta_i &= {\tilde{\Lambda}}_i + m - n - 1 - i, &1\leq i\leq m, \\
\beta_\mu &= \mu-{\tilde{\Lambda}}_\mu - n - 1, &1\leq \mu \leq n + 1.  
