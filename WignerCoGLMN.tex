...
nondegenerate sesquilinear form on the tensor product space $V(\Lambda) \otimes V(\mu)$ induced by the natural forms on $ V(\Lambda)$ and $V(\mu)$ \cite{GIW1}. The restriction of this form to the isotypic component of a given typical submodule is nondegenerate, which allows the definition of Wigner coefficients with respect to the form.
